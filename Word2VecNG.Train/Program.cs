...
namespace Word2VecNG.Train
{
	internal static class Program
	{
		...
		private const uint latentTokenSize = 512;
		private const int orderedContextLookaroundSize = 3;
		private const ulong preHash = 3;


		private const uint hashesPerWord = 4;

		private const int unorderedPastLookaround = 4;
		private const int unorderedFutureLookaround = 4;
